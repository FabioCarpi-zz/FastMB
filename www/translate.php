...
if($_GET["tipo"] == "Ordens" and $_GET["pair"] == "btc"){
    ...
    echo file_get_contents("https://www.mercadobitcoin.net/api/trades/".strtotime("-24 hours"));
    ...
    echo file_get_contents("https://www.mercadobitcoin.net/api/trades_litecoin/".strtotime("-24 hours"));
}